...
mock <- list(
  ...
  weather_observation_response = hereR:::.async_request(url_weather_observation, 5),
  weather_forecast_hourly_response = hereR:::.async_request(url_weather_forecast_hourly, 5),
  weather_forecast_astronomy_response = hereR:::.async_request(url_weather_forecast_astronomy, 5),
  weather_alerts_response = hereR:::.async_request(url_weather_alerts, 5),
