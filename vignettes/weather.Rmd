...
```{r table_obs, eval=TRUE, out.width='100%', echo=FALSE}
...
mapview(observation,
        zcol = "temperature",
        cex = as.numeric(observation$humidity)/4,
...
```{r table_ast, eval=TRUE, out.width='100%', echo=FALSE}
ast <- astronomy$astronomy[[1]]
ast$date <- as.Date(as.POSIXct(ast$utcTime))
