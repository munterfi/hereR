...
The Geocoder Autocomplete API can be accessed using the `autocomplete` function. The `results` parameter defines the maximum number of suggestions that should be requested per address.
