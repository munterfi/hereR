test_that("route works", {
  ...
  # Input checks
  expect_error(route(origin = c(1, 2, 3), destination = poi), "'points' must be an sf object.")
  expect_error(route(origin = c("character", NA), destination = poi), "'points' must be an sf object.")
